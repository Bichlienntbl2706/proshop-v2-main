...
function sendEmail({ recipient_email, OTP }) {
  return new Promise((resolve, reject) => {
    ...
    const mail_configs = {
      ...
      to: recipient_email,
      subject: 'De Pureté PASSWORD RECOVERY',
      html: `<!DOCTYPE html>
                <html lang="en" >
                <head>
                    <meta charset="UTF-8">
                    <title>De Pureté - OTP Email Template</title>
                ...
                <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
                    ...
                    <p>Thank you for choosing De Pureté Essential Oil. Use the following OTP to complete your Password Recovery Procedure. OTP is valid for 5 minutes</p>
